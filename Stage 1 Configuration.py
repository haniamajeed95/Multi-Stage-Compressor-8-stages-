...
# Shaft diameter based on preliminary criterion   
        ...
        beta_tt_imp   = ((delta_h_0)/(c_p*T_01)+1)**(n/(n-1))   # Impeller total to total pressure ratio   [-]                                             # Impeller total to total pressure ratio (= stage target, by construction of delta_h_0)   [-]   
...
#Impeller Incidence Loss
        ...
        beta1_bl  = beta1+degrees(5)                                         # Impeller inlet blade angle                    [deg]
        finc      = 0.5                                                     # Incidence friction loss coefficient           [-]
        delta_hin = finc*w_1_t**2*sin(beta1-beta1_bl)**2                     # Impeller incidence loss                       [J/kg]
...
#=======================================================================#
        ...
        D_range = [D_start + 0.002*j for j in range(200)]
